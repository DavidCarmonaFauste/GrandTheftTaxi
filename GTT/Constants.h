...
//Weapons
const WeaponInfo GUN{ "../Assets/sprites/gun.png", "../Assets/sprites/pistola_anim.png",2, "gun", 75, 150, 10, 150, 1500, 0.45, 0.1, 1000, GUNBULLET, SHOTGUNBULLET, LINEAR, LINEAR, false};
const WeaponInfo SHOTGUN{ "../Assets/sprites/shot_gun.png", "../Assets/sprites/escopeta_anim.png",3, "shotgun", 75, 150, 6, 900, 4000, 0.6, 0.2, 2000, SHOTGUNBULLET, GUNBULLET, SPREAD, SPREAD, false, 30.0, 3};
